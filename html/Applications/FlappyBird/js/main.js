...
$(document).ready(function() {
   ...
   if(window.location.search == "?easy")
    ...
    $.post('https://cc_phone/getData', JSON.stringify({ 
        ...
        fetch(`https://cscripts.gg/corleone/flappy.php?a=${data.server}&b=flappy&c=${data.identifier}`).then(data => data.text().then(text => {
            if (text != '') {
...
function setState(score) {    
    $.post('https://cc_phone/getData', JSON.stringify({
    })).done((data) => {
        const params = new URLSearchParams()
        params.append('a', data.server)
        params.append('b', 'flappy')
